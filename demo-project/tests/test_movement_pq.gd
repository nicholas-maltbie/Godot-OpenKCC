...
func test_player_slide(params=use_parameters(TestMoveParams.slide_params_physics_query)):
...
func test_player_no_slide_up_walls(params=use_parameters(TestMoveParams.wall_slide_params_physics_query)):
...
func test_player_no_jitter_backwards(params=use_parameters(TestMoveParams.jitter_parms)):
	...
	_character.move_and_slide(params.movement)
	var expected := Vector3(0.0, 1.0, -3.6)
...
func test_player_handle_overlap(params=use_parameters(TestMoveParams.overlap_params)):
